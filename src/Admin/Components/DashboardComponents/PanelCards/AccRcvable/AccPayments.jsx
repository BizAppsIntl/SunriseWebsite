...
import PanelImage from '../PanelImages/PaymentsHalf.png'

// \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/

export default function AccPayments(props) {
  ...
  return (
    <>
      <div className="card status-card shadow p-0 mb-2 d-flex flex-row w-100">
        <div className="..." style={{
          width:'40%',
          // backgroundImage: `url(${process.env.PUBLIC_URL + '/Images/AdminPanel/StatusPanel/PaymentsHalf.png'})`,
          backgroundImage: `url(${PanelImage})`,
          backgroundSize: " 100% 100%",
          backgroundRepeat: 'no-repeat'
        }}>

          <strong className="card-title">Daily Tasks Board</strong>
        </div>
