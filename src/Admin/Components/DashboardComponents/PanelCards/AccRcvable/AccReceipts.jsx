...
import PanelImage from '../PanelImages/ReceiptsHalf.png'
// import '../Card.css'
// import pic from '../../../../../public/Images/AdminPanel/Site/PayAble550x512.png'

// \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/

export default function AccReceipts(props) {
  ...
  return (
    <>
      <div className="card status-card shadow p-0 mb-2 d-flex flex-row w-100">
        <div className="..." style={{
          width:'40%',
          // backgroundImage: `url(${process.env.PUBLIC_URL + '/Images/AdminPanel/StatusPanel/ReceiptsHalf.png'})`,
          backgroundImage: `url(${PanelImage})`,
          backgroundSize: " 100% 100%",
          backgroundRepeat: 'no-repeat'
        }}>
          <strong className="card-title">Duty Roster</strong>
        </div>
