...
const AccCodeMain = '41211'

// export default function SalesInvoices(props) {
export default function SalesInvoices({ Rec }) {
    ...
    <>
      ...
      <PanelCard Img={'Invoice.png'}>
        <div className='flex flex-col '>
          ...
          <strong className="text-center">Sales Invoices</strong>
          ...
          <div className="pe-2 leading-none" style={{ fontSize: '12px' }}>
            ...
            {/* <div className="text-end leading-none"><span> <small><Link href="/">More ...</Link></small></span>     </div> */}
          </div>
