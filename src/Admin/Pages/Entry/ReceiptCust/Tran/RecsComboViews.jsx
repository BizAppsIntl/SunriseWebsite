...
export default function RecsComboViews({ RecAll, HandleListItemClicked, SizeFlagFS }) {
    ...
    return (<>
        ...
        <div className="card-header py-0 w-full flex items-center" style={{ background: '#e0e0e0' }}>
            ...
            <div className='flex gap-3 items-center mx-auto' style={{ lineHeight: '1', zIndex: '10' }}>
                {/* <div className='flex '>
...
<p> akert gereewe</p>       
                        : <>
                            {FilteredRecs.map((E, I) => {
                                ...
                                return (
                                    <button className='btn btn-sm flex px-1 py-0 text-start border-bottom '
                ...
                :
                <div className="btn-group flex flex-row flex-wrap m-0 justify-evenly" role="group" aria-label="First group">
                    {FilteredRecs.length <= 0 ?
                        // <BoxMessage variant='danger' className='text-black' >Seems, There is No Data...</BoxMessage>
                        // <Alert variant='info' className='text-black'> Check Period and Click  <RiSearchEyeLine className='mb-1 text-black' style={{ width: '26px', height: '26px' }} /> again    </Alert>
