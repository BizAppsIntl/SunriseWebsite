...
const InfoCard = ({ InfoRec }) => {
    const { Code, Title, PicURL, RecType, Desc, Rem, Priority, Address, Phone, ContactPerson, ContactPhone, ContactPerson2, ContactPhone2, PreBal, CrntBal } = InfoRec
    return (
        <>
                    ...
                    <div>
                        <table><tbody>
                            ...
                            <tr>
                                ...
                                <td> <span className='fs- ' > {Address.trim() + ' '+ Phone }   </span> </td>
                            </tr>
                            <tr>
                                <th> <span className='fs-6 fw-bold  ' >Contact Person:  &ensp;  </span></th>
                                <td> <span className='fs- ' > {ContactPerson + ' '+ ContactPhone}   </span> </td>
                            </tr>
                            <tr>
                                <th> <span className='fs-6 fw-bold ' >Other Contact:  </span></th>
                                <td> <span className='fs- ' > {ContactPerson2 + ' '+ ContactPhone2}   </span> </td>
                            </tr>
