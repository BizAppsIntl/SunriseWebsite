      ...
      {OrderSheetItems.map((E, I) =>
        <div className='card d-flex flex-row  align-items-center mb-2' style={{ fontSize: '12px' }} key={I}>
          ...
          <div className='d-flex text-center align-items-center mx-0 px-0 ' style={{ width: "20%" }}  >
            ...
            {/* QUANTITY   */}
            <input type="text" name="Qty" id="Qty" value={E.Qty} className='p-0 m-0 fs-6 w-100 fw-bold text-danger text-center text-decoration-underline ' style={{ border: 'none' }}               onChange={(e) => HandleInputs(E, e)} />
