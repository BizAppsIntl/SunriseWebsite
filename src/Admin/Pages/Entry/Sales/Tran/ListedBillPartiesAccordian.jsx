...
export default function ListedBillPartiesAccordian(props) {
    ...
    return (<>
        {/* <div className="d-flex flex-wrap justify-content-evenly " style={{overflow:'hidden'}}> */}
                ...
                {/* <AccordianCard key={E.TId} RecItm={E} HandlePrint={HandlePrint}/> */}

        <div className="card-header py-0 w-100 d-flex align-items-center" style={{ background: '#e0e0e0' }}>
            <strong className='fs-5'>Customers</strong>
        ...
        <div className="card-body p-0 mt-1" style={{ overflowY: 'auto' }}>
            {DispType
                            ...
                            <button className='btn btn-sm d-flex px-1 py-0 text-start border-bottom '
                                ...
                                {(SelectedItem = OrderSheet.TId === ITM.Id)
                                    ...
                                    <>
                                        <span className='borderX text-center' style={{ width: '10%' }}>
                                            {(ITM.PicURL && ITM.PicURL.trim())
                                                ...
                                                />
                                                : <span className='d-flex justify-content-center' onClick={(e) => HandleListItemClicked(ITM)}> <MyAvatar Text={ITM.Title[0]} Size={24} /> </span>
                                            }
                                        </span>
                                        ...
                                        {/* <span className="d-flex gap-2 justify-content-end align-items-center" style={{ width: '10%' , fontSize: '16px' }} >
                                    ...
                                    <>
                                        <span className='borderX text-center' style={{ width: '5%' }}>
                                            {(ITM.PicURL && ITM.PicURL.trim())
                                                ? <img src={
                                                    ...
                                                    alt="..." onClick={(e) => HandleListItemClicked(ITM)}
                                                />
                                                : <span className='d-flex justify-content-center' onClick={(e) => HandleListItemClicked(ITM)}> <MyAvatar Text={ITM.Title[0]} Size={15} /> </span>
                                            }
                                        </span>
                                        ...
                                        {/* <span className="d-flex gap-2 justify-content-end align-items-center" style={{ width: '10%' , fontSize: '12px' }} >
                                            <div onClick={(e) => { e.stopPropagation(); setSelectedRec(ITM.Id); OrderItemAdd(ITM.Id, 'R', ITM) }}>
                ...
                :
                <div className="btn-group d-flex flex-row gap-2 flex-fill flex-wrap m-0 justify-content-evenly" role="group" aria-label="First group">
                    {Traders.map((ITM, I) => {
                        return (<>

                            <div className= {`card shadow  p-0 mb-1 `+ ((SelectedItem = OrderSheet.TId === ITM.Id)? ' border border-danger shadow-lg ': '')}  style={{ maxWidth: '100px', minWidth: '90px' }} >
...
{(ITM.PicURL && ITM.PicURL.trim())
                                        ? <img src={
                                            ...
                                            alt="..." onClick={(e) => HandleListItemClicked(ITM)}
                                        />
                                        : <span className='d-flex justify-content-center' onClick={(e) => HandleListItemClicked(ITM)}> <MyAvatar Text={ITM.Title[0]} Size={75}  /> </span>
                                    }
