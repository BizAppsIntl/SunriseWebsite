                        ...
                        <div className='flex justify-between items-center' style={{ fontSize: '14px' }}>
                            ...
                            >
                                ...
                                <div className="relative w-full border-red-100 border">
                                    ...
                                    <Select className=" rounded-t-lg px-2.5 pb-0 pt-4 w-full text-sm text-gray-900 border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
