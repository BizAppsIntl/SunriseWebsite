    ...
    <>
      ...
      <div className='card d-flex  m-0 p-1 flex-column text-start' style={{ width: '100%', fontSize: '12px', background: '#e0e0e0', borderRadius: '5px' }}>
        ...
        <div className='card-header d-flex gap-1 py-1 m-0 justify-content-between ' style={{ background: '#bebebe' }}>
          <span className='fs-6'><strong>Items Detail</strong></span>
          ...
          <div className="d-flex p-0 gap-1 m-0 justify-content-between ">
            ...
            <div className="card p-1" style={{ width: "40%" }} >
              ...
              <div className='d-flex gap-2'>
                {/* ---[ Input Code ]--- */}
                <div className="d-flex mt-2 w-50">  {/* <div className="input-group"> */}
                  <div className="input-group-text"><TbListDetails /></div>
                  <div className="form-floating w-100" >
                    <input type="text" value={Code} maxLength={5} className="form-control  text-end" name='Code' placeholder="Code" onChange={(e) => HandleInputs(e)} />
                    <label htmlFor="Code"  >Code</label>
                  </div>
                </div>


                {/* ---[ Input IsContracted Item ]--- */}
                <div className="d-flex  mt-2 w-50" style={{ height: '42px' }}>
                  {/* <span className="input-group-text px-0 py-0" >
                    <img alt="Gender" width='42px' height='42px' */}
                  <div className="input-group-text"><TbListDetails /></div>

                  <div className="d-flex w-100 flex-column align-items-stretch w-100 border border-1 rounded-2 " >
                    <span className='px-3' style={{ fontSize: 'smaller' }}  >Is Contracted ?</span>

                    <div className="d-flex mt-1 justify-content-evenly" >
                      <div className="form-check " onClick={() => setOrderSheet({...OrderSheet, Contracted:'1', PPrice:0})} >
                        {/* <input className="form-check-input" type="checkbox" defaultValue id="flexCheckDefault"  Checked={true} defaultChecked /> */}
                        < input className='form-check-input' type="radio" name="ContractedYes" checked={Contracted === '1'} value={Contracted} id="flexCheckDefault" />
                        <label className={`form-check-label  ${(Contracted === '1') && ' text-danger'} `}  htmlFor="flexCheckDefault">Yes</label>
                      </div>
                      <div className="form-check " onClick={() => setOrderSheet({...OrderSheet, Contracted:'0'})}>
                        <input className="form-check-input" type="radio" name="ContractedNo" checked={Contracted === '0'} value={Contracted} id="flexCheckChecked" />
            ...
            <div className="card p-1" style={{ width: "40%" }} >
              ...
              <div className="d-flex  mt-3">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  ...
                  <select className="form-control ps-2 pb-0 pt-3 text-end"
                    ...
                    name="CatItemCode" placeholder="Procedure Type"
                  ...
                  <label htmlFor="CatItemCode"  >Procedure Type</label>
                </div>
              </div>
              ...
              <div className="d-flex mt-3">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  <input type="text" value={Rem} maxLength={10} className="form-control  text-end" name='Rem' placeholder="Rem" onChange={(e) => HandleInputs(e)} />
              ...
              {/* divider line --------------------------------------------------------------------------*/}
              <div className="mx-auto my-4 " style={{ width: '90%', borderTop: "2px solid lightgray " }}></div>
              ...
              <div className="d-flex gap-1 mt-0">
                ...
                <div className="d-flex mt-0 w-50">  {/* <div className="input-group"> */}
                  ...
                  <div className="form-floating w-100" >
                    <input type="text" value={RecStatus} maxLength={10} className="form-control  text-end" name='RecStatus' placeholder="RecStatus" onChange={(e) => HandleInputs(e)} />
                ...
                <div className="d-flex mt-0 w-50">  {/* <div className="input-group"> */}
                  ...
                  <div className="form-floating w-100" >
                    <input type="text" value={Priority} maxLength={10} className="form-control  text-end" name='Priority' placeholder="Priority" onChange={(e) => HandleInputs(e)} />
          ...
          <div className="d-flex p-0 gap-1 m-0 justify-content-between ">
            ...
            <div className="card p-2" style={{ width: "33%" }} >
              ...
              <div className="d-flex mt-0">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  <input type="text" value={Unit} maxLength={10} className="form-control  text-end" name='Unit' placeholder="Unit" onChange={(e) => HandleInputs(e)} onFocus={handleFocus} />
              ...
              <div className="d-flex mt-3">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  <input type="text" value={PPrice} className="form-control  text-end" name='PPrice' placeholder="PPrice" onChange={(e) => HandleInputs(e)} onFocus={handleFocus} />
            ...
            <div className="card p-2" style={{ width: "33%" }} >
              ...
              <div className="d-flex mt-0">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  ...
                  <label htmlFor="QtyDef"  >Default Addition in Cart</label>
                </div>
              </div>
              ...
              <div className="d-flex mt-2">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  ...
                  <label htmlFor="QtyStep"  >Incremental Step</label>
                </div>
              </div>
            ...
            <div className="card p-2" style={{ width: "33%" }} >
              ...
              <div className="d-flex mt-3">  {/* <div className="input-group"> */}
                ...
                <div className="form-floating w-100" >
                  {/* <input type="text" disabled value={CrntBal} className="form-control text-end" name='CrntBal' placeholder="QtyMax" onChange={(e) => HandleInputs(e)} onFocus={handleFocus} /> */}
