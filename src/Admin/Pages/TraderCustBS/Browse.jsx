...
export default function Browse() {
  ...
  const DataFetchAll = async (signal) => {
    ...
    const res = await fetch(`/api/TranPayment/${_VCat}`, { signal });
      ...
      <div className="card">
        ...
        <div className="card-header px-2 d-flex  justify-content-between align-items-center" style={{ height: 30, backgroundColor: '#E1BEE7' }}>
          ...
          <div className="d-flex  gap-2 align-items-center">
            ...
            <span className='fs-4'> Browsing: Payment Vouchers</span>
          </div>
          ...
          <div className="d-flex  gap-2 align-items-center">
            ...
            <div className="btn-group">
              ...
              <div className="input-group">    {/* ...[ Input SEARCH ]... */}
                ...
                <span onClick={() => { setBtnTxt2Search(Txt2Search) }} className="input-group-text btn btn-warning" style={{ marginLeft: '-1', padding: '0px 4px', width: '30px', height: '25px' }} ><img src={IconSearch} alt="Search" width='20' height='20' /> </span>
              </div>
            </div>
