...
export default function CodeTestPage() {
  ...
  return (
    <div>
      ...
      <button
        onClick={openModal}
        className="p-2  mx-4 bg-blue-500 text-white rounded"
      >
        Open My Custom Modal
      </button>

      {/* <MyCustomModal isOpen={isModalOpen} onClose={closeModal}  > */}
      <MyCustomModal isOpen={isModalOpen} onClose={()=>setIsModalOpen(false)}  >
        <div className='py-4 bg-indigo-500'>
          <h2 className="text-lg font-semibold ">Modal Title</h2>
        </div>

        <div className='bg-slate-500'>
          <p className="text-gray-700"> This is the modal content. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus cum doloribus architecto! Repellendus, eligendi veniam quasi nulla commodi accusamus sequi similique consequuntur autem repudiandae rem aspernatur magnam. Magnam, commodi eius?</p>
        </div>
      ...
      {/* Button to toggle BtnAddnewClicked state */}
      <button
        onClick={() => setModalIsOpen(!ModalIsOpen)}
        className="mb-4 p-2 bg-blue-500 text-white rounded"
      >
        Toggle React Modal: {ModalIsOpen ? 'True' : 'false'}
      </button>
      ...
      {/* {ModalIsOpen  && <Modal isOpen={ModalIsOpen} style={customStyles}  onRequestClose={() => setModalIsOpen(false)}> Hello in Modal </Modal> } */}
      {/* {ModalIsOpen  && <Modal isOpen={ModalIsOpen}  onRequestClose={() => setModalIsOpen(false)}> Hello in Modal </Modal> } */}
      ...
      {ModalIsOpen &&
        <Modal isOpen={ModalIsOpen} style={{
          ...
          <div className="card w-[300px] h-[500px] mx-60">
            <div className="card-header px-2 flex  justify-between items-center" style={{ height: 30 }}>
              <div>Title case</div>
              <button onClick={() => setModalIsOpen(false)}>x</button>
            </div>

            <div className="card-body p-1 flex flex-row justify-center  " style={{}}>

              {"<PrnTranPymtRefDteDetail ref={PRINT_REF} SearchInput={SearchInput} Data2Rpt={DATA_RECS} />"}
            </div>
          </div>
        </Modal>
      }
      ...
      <div className="grid items-end gap-6 mb-6 md:grid-cols-3">
        <div className="relative">
          <input type="text" id="small_filled" className="block rounded-t-lg px-2.5 pb-1.5 pt-4 w-full text-sm text-gray-900 bg-gray-50 border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
          <label for="small_filled" className="absolute text-sm text-gray-500 duration-300 transform -translate-y-3 scale-75 top-3 z-10 origin-[0] start-2.5 peer-focus:text-blue-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">Small filled</label>
        </div>
        <div className="relative">
        ...
        <div className="relative z-0">
          <input type="text" id="small_standard" className="block w-full px-0 py-2 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
          <label for="small_standard" className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">Small standard</label>
        </div>
      </div>
      ...
      {/* Button to toggle BtnAddnewClicked state */}
      <button
        onClick={() => setBtnAddnewClicked(!BtnAddnewClicked)}
        className="mb-4 p-2 bg-blue-500 text-white rounded"
      >
        Toggle View
      </button>
      ...
      <div className="flex flex-wrap">
        ...
        <div
          className={
            BtnAddnewClicked
              ? 'w-full md:w-[40%] p-4 bg-gray-200'
              : 'w-full p-4 bg-gray-200'
          }
        >
          <h2>Card A</h2>
          <p>This is Card A content.</p>
        </div>

        {/* CardB */}
        {BtnAddnewClicked && (
          <div className="w-full md:w-[60%] p-4 bg-gray-300">
            <h2>Card B</h2>
            <p>This is Card B content.</p>
          </div>
        )}
      </div>
      ...
      <div className="block space-y-4 md:flex md:space-y-0 md:space-x-4 rtl:space-x-reverse">
        {/* <!-- Modal toggle --> */}
        <button data-modal-target="small-modal" data-modal-toggle="small-modal" className="block w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
          Small modal
        </button>
        ...
        <button data-modal-target="extralarge-modal" data-modal-toggle="extralarge-modal" className="block w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
          Extra large modal
        </button>
      </div>

      {/* <!-- Small Modal --> */}
      <div id="small-modal" tabindex="-1" className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div className="relative w-full max-w-4xl max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="large-modal">
                <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                </svg>
                <span className="sr-only">Close modal</span>
            ...
            <div className="flex items-center p-4 md:p-5 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
              ...
              <button data-modal-hide="large-modal" type="button" className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Decline</button>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* <!-- Extra Large Modal --> */}
      <div id="extralarge-modal" tabindex="-1" className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      ...
      <div className="px-6">
        <h2 className="text-sm font-semibold mb-2">Next script must be included:</h2>
        <pre className="bg-gray-800 text-white p-4 rounded-lg overflow-x-scroll">
