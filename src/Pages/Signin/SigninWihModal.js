...
export default function StandardInputPage() {
  ...
  const [OpenModal, setOpenModal] = useState(TriggerValue);
  ...
  return (
    <>
      ...
      <p>{OpenModal ? ' OpenModal is true' : 'OpenModal isfalse'}</p>
          ...
          <div className="mt-4 ">
            ...
            <div className="flex gap-4 md:px-4  ">
              <div className="w-[100px] h-[100px] ">
                <img src={'/assets/default/DrCouple.png'} width="0"
                  height="0"
                  sizes="100vw"
              ...
              <div className="w-full">
                ...
                {/* Input Code/ID  */}
                <div className=' '>
                  <input Label='ID/ Email' Name='ID' Icon={<FaUser />} Val={OrderSheet?.ID} setVal={HandleInputs} className={' text-md text-left text-red-600'} />
                  {/* <InputByAdaamSelect Options={BizType} TextKey='BizType' Icon={<FaUserPlus/>} ValueKey='Value' /> */}
                </div>

                {/* Input Descriptions  */}
                <div className='mt-4'>
                  <input Label='Pass Code' Name='PW' Icon={<FaUserPlus />} Val={OrderSheet?.PW} setVal={HandleInputs} />
                </div>
