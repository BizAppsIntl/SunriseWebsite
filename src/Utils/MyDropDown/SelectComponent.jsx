...
const SelectComponent = React.forwardRef(
  (
    ...
    return (
      <div className="MyDrpDndropdown-container" ref={ref}>
        <div className="MyDrpDninput-container" onClick={onInputClick}>
          <input
            type="text"
            value={inputValue}
          ...
          />
          <div className="MyDrpDninput-arrow-container">
            <i className="MyDrpDninput-arrow" />
          </div>

          {selectedKey || inputValue ? (
            <div className="MyDrpDninput-clean-container" onClick={clearDropdown}>
              x
            </div>
          ) : null}
        </div>
